...
# CGCNN
class MPNN_AUG(torch.nn.Module):
    def __init__(
        self,
        data,
        dim1=64,
        ...
        **kwargs
        ...
        if post_fc_count > 0:
            ...
            for i in range(post_fc_count):
                if i == 0:
                    ...
                    if self.pool_order == "early" and self.pool == "set2set":
                        ...
                        lin = torch.nn.Linear(post_fc_dim+32+7, dim2)
            ...
            if self.pool_order == "early" and self.pool == "set2set":
                ...
                self.lin_out = torch.nn.Linear(post_fc_dim+32+7, output_dim)   
