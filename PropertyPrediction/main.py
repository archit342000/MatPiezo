...
def main():
    ...
    ##Predicting from a trained model
        ...
        train_error = training.predict(
            dataset, config["Training"]["loss"], config["Job"], config["Processing"]
        )
    ...
    ##Hyperparameter optimization
        ...
        hyper_args = {}
        dim1 = [x * 20 for x in range(1, 10)]
        dim2 = [x * 20 for x in range(1, 10)]
        dim3 = [x * 20 for x in range(1, 10)]
        batch = [x * 20 for x in range(1, 10)]
